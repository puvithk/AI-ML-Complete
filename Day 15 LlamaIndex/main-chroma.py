...
chroma_colletcion = chroma.get_or_create_collection('puvith')
vector_store = ChromaVectorStore(chroma_collection=chroma_colletcion)
...
source_docs = [
    Document(text=project['text'] ,metadata = {'title' : project['title'] ,'domain' : project['domain']} )
...
response = query_engine.query("List all the project related to AI and ML ?")
print(response)